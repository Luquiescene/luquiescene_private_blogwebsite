...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			...
			mobile: [
				"/assets/mobile-banner/001.webp",
				"/assets/mobile-banner/002.webp",
				"/assets/mobile-banner/003.webp",
			], // 移动横幅图片
		}, // 使用本地横幅图片
...
export const announcementConfig: AnnouncementConfig = {
	title: "关于可能遇到莫名其妙BUG的公告", // 公告标题，填空使用i18n字符串Key.announcement
	content: "博主初次建立博客网站，该网站可能因各种原因运行不稳定，请各位多多包涵。时间线、技能、设备、相册功能暂时关闭，这些网页返回404代码属于正常现象。", // 公告内容
